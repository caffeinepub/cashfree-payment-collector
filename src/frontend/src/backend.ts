...
import type { Payment as _Payment, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCashfreeOrder(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<CashfreeOrder> {
        if (this.processError) {
            try {
                const result = await this.actor.createCashfreeOrder(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFilteredPayments(arg0: string): Promise<Array<Payment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredPayments(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPaymentStatus(arg0: string): Promise<Payment | null> {
        if (this.processError) {
            try {
    ...
    async getSortedPayments(): Promise<Array<Payment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedPayments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async handleCashfreeWebhook(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.handleCashfreeWebhook(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Payment]): Payment | null {
